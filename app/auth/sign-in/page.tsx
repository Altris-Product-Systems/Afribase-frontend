        ...
        <div className="w-full max-w-md animate-fade-in-up">
          ...
          <div className="space-y-3 mb-8">
            <button className="w-full flex items-center justify-center gap-3 px-4 py-3.5 border border-white/10 bg-white/5 rounded-xl hover:bg-white/10 transition-all duration-300 hover:border-white/20 active:scale-[0.98]">
              ...
              <span className="ml-auto px-2 py-1 bg-white/10 text-[10px] font-bold text-white rounded-md tracking-wider">
                LAST USED
              </span>
            </button>
            ...
            <button className="w-full flex items-center justify-center gap-3 px-4 py-3.5 border border-white/10 bg-white/5 rounded-xl hover:bg-white/10 transition-all duration-300 hover:border-white/20 active:scale-[0.98]">
              <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 12h7.54A7.54 7.54 0 1112 4.46V12z" />
                <path d="M12 12v7.54A7.54 7.54 0 1012 4.46V12z" opacity="0.5" />
              </svg>
              <span className="text-sm font-semibold text-white">
                Continue with SSO
              </span>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/auth/forgot-password" className="text-sm font-medium text-sage hover:text-white transition-colors">
                  Forgot password?
                </Link>
              </div>
          ...
          <p className="mt-8 text-center text-sm text-white/60">
            Don't have an account?{' '}
            <Link href="/auth/sign-up" className="font-bold text-white hover:text-sage transition-colors">
              Sign up
            </Link>
          </p>
        </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-16 overflow-hidden">
        ...
        <div className="max-w-xl relative z-10 animate-slide-in-right">
          ...
          <blockquote className="text-3xl font-medium text-white mb-10 leading-relaxed">
            "It's fun, feels lightweight, and really quick to spin up user auth and a few tables. Almost <span className="text-sage">too easy!</span> Highly recommend."
          </blockquote>
